...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            &nbsp;&nbsp;
            <asp:Button ID="SubmitButtonChoice" runat="server" Text="Submit Choice" 
                 CssClass="btn btn-primary" OnClick="SubmitButtonChoice_Click" />
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 text-right">
            <asp:Label ID="Label2" runat="server" Text="RadioButtonList:"
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            &nbsp;&nbsp;
            <asp:LinkButton ID="LinkButtonCollecetion" runat="server" OnClick="LinkButtonCollecetion_Click">Submit choice from List</asp:LinkButton>
        </div>
    </div>
    <div class="row">
