<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JobApp.aspx.cs" Inherits="WebApp.SamplePages.WebForm1" %>
    ...
    <div class="row">
        <div class="col-md-offset-1 col-md-10">
            <blockquote class="alert alert-info" style="font-style:italic">
                ...
                The form will investigate the processing for a CheckBoxList. Data diplay will be to a 
                simple string.
            </blockquote>
        </div>
    </div>
