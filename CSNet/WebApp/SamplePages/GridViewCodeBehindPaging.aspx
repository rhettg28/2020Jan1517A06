<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GridViewCodeBehindPaging.aspx.cs" Inherits="WebApp.SamplePages.GridViewCodeBehindPaging" %>
     ...
     <div class="row">
        <div class="col-md-6">
            ...
            <asp:GridView ID="ProductList" runat="server" AutoGenerateColumns="False"
                 ...
                 AllowPaging="true" PageSize="4" PagerSettings-Mode="Numeric" OnPageIndexChanging="ProductList_PageIndexChanging">
