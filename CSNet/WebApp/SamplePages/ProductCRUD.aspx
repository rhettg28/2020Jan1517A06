...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="page-header">
    ...
    <asp:RequiredFieldValidator ID="RequiredProductName" runat="server" ErrorMessage="Product Name is required"
   ...
   <div class="row">
      ...
      <%--  this will be the lookup control area--%>
         <div class="col-md-12"> 
             ...
             <asp:LinkButton ID="RemoveProduct" runat="server" Font-Size="X-Large" 
                  ...
                  OnClientClick="return confirm('Are you sure you want to discontinue this product?')">Remove</asp:LinkButton>&nbsp;&nbsp;
      ...
      <%--  this will be the entity CRUD area--%>
        <div class ="row">
            ...
            <div class="col-md-6 ">
                ...
                <asp:DropDownList ID="SupplierList" runat="server" Width="350px" DataSourceID="SupplierListODS" DataTextField="CompanyName" DataValueField="SupplierID"
                     AppendDataBoundItems="true">
                    <asp:ListItem Value="0">.....</asp:ListItem>
                </asp:DropDownList><br />
                <asp:DropDownList ID="CategoryList" runat="server" Width="350px" DataSourceID="CategoryListODS" DataTextField="CategoryName" DataValueField="CategoryID"
                     AppendDataBoundItems="true">
                    <asp:ListItem Value="0">.....</asp:ListItem>
                </asp:DropDownList><br />
    ...
    <asp:ObjectDataSource ID="SupplierListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Suppliers_List" TypeName="NorthwindSystem.BLL.SupplierController">
